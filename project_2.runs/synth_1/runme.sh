...
HD_PWD='C:/Users/Zach/Documents/GradSchool/Fall_2019/EN525.742_SOC_Design_Lab/EN525.742_Project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project2_top.tcl
